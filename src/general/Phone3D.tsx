...
const Phone3D: FunctionComponent = (props) => {
    const { nodes, materials } = useGLTF(
        'https://mohc-ltd.github.io/mohc-website/public/jbc_iphone_hero-v2.glb'
    ) as GLTFResult
...
useGLTF.preload('https://mohc-ltd.github.io/mohc-website/public/jbc_iphone_hero-v2.glb')
